#ifndef INTRIN_SUBSET_C_EMU_H
#define INTRIN_SUBSET_C_EMU_H
...
static inline __M256I _MM256_aesenc_epi128(__M256I a, __M256I RoundKey) {
    __M256I c;
    for(size_t i = 0; i < sizeof(c.val)/16; ++i) {
        AESROUND(c.val + 16 * i, a.val + 16 * i, RoundKey.val + 16 * i);
    }
    return c;
}
...
static __M128I _MM256_extracti128_si256(__M256I a, const int imm8) {
    __M128I c;
    if ((0 <= imm8) && (imm8 < sizeof(a.val)/16)) {
        memcpy(c.val, a.val + 16 * imm8, 16);
    }
    else {
